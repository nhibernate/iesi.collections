...
#endif
{
	...
	/// </summary>
	int CountOthers(IEnumerable<T> items, out int numberOfOthersPresent)
	{
	...
	/// </summary>
	static ISet<T> AsSet(IEnumerable<T> items)
	{
	...
	/// </summary>
	void Unlink(LinkedHashNode<T> node)
	{
